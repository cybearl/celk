...
void Ripemd160::compress(uint32_t state[5], const uint8_t blocks[], size_t len) {
    ...
    for (size_t i = 0; i < len;) {
        ...
        for (int j = 0; j < 16; j++, i += 4) {
            schedule[j] = static_cast<uint32_t>(blocks[i + 0]) << 0 | static_cast<uint32_t>(blocks[i + 1]) << 8
                | static_cast<uint32_t>(blocks[i + 2]) << 16 | static_cast<uint32_t>(blocks[i + 3]) << 24;
        }
...
uint32_t Ripemd160::f(int i, uint32_t x, uint32_t y, uint32_t z) {
    switch (i >> 4) {
        ...
        default:
            assert(false);
            return 0; // Dummy value to please the compiler
    }
}
...
const unsigned char Ripemd160::RL[NUM_ROUNDS] = { 0,
    1,
    2,
    3,
    4,
    ...
    15,
    13 };
const unsigned char Ripemd160::RR[NUM_ROUNDS] = { 5,
    14,
    7,
    0,
    9,
    ...
    9,
    11 };
const unsigned char Ripemd160::SL[NUM_ROUNDS] = { 11,
    14,
    15,
    12,
    5,
    ...
    5,
    6 };
const unsigned char Ripemd160::SR[NUM_ROUNDS] = { 8,
    9,
    9,
    11,
    13,
