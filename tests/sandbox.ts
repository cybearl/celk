...
//     privateKey = privateKeyGenerator.privateKey.readBigInt(privateKeySlot.start, privateKeySlot.length)
...
const cache = Cache.fromUint32Array(new Uint32Array([0xff11ff22, 0x11ff11ff]))
